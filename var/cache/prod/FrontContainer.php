...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'prestashop', 'user' => 'prestashopuser', 'password' => 'test', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.7', '/var/www/html/prestashop', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.8.7', '/var/www/html/prestashop');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'secret' => 'LNR4GYVK0PfPKBZMT3nGIOWjOwrHpk0H9HK4IVPranoy4teTVYLkSstbtwQH5hMS',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2022-10-25',
            'locale' => 'en-US',
            'use_debug_toolbar' => true,
            'cookie_key' => 'wyNuLGaJtgtxviP4eM70qvW6S368dVDy1MqkLqKcYGfLHfjEgwMuZdPSsVwD6Sac',
            'cookie_iv' => 'h17pULi2LAcC5PZGaWrOxMtpRcQz78GN',
            'new_cookie_key' => 'def00000d34f5101147baedfa603b100aa105edfe24daa451f3c92a9b2eac62987c447e03317612d28895a3f2b0e0363de8fdab706578073ae74719f7d954dce6370d397',
            'cache.driver' => 'array',
            'kernel.bundles' => [
